...
// Single Responsibility Principle - this component only handles displaying social links
const SocialLinks = ({ social = {} }) => {
  ...
  return (
    <div className="py-4 sm:py-5 sm:px-6">
      <dt className="text-sm font-medium text-gray-500 mb-2">Social Links</dt>
